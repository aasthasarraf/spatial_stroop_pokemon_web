...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'stimuli/1.bmp', 'path': 'stimuli/1.bmp'},
    {'name': 'stimuli/5.bmp', 'path': 'stimuli/5.bmp'},
    {'name': 'stimuli/7.bmp', 'path': 'stimuli/7.bmp'},
    {'name': 'stimuli/9.bmp', 'path': 'stimuli/9.bmp'},
    {'name': 'stimuli/14.bmp', 'path': 'stimuli/14.bmp'},
    {'name': 'stimuli/15.bmp', 'path': 'stimuli/15.bmp'},
    {'name': 'stimuli/19.bmp', 'path': 'stimuli/19.bmp'},
    {'name': 'stimuli/20.bmp', 'path': 'stimuli/20.bmp'},
    {'name': 'list_stim_incongruent_practice.xlsx', 'path': 'list_stim_incongruent_practice.xlsx'},
    {'name': 'stimuli/6.bmp', 'path': 'stimuli/6.bmp'},
    {'name': 'stimuli/7.bmp', 'path': 'stimuli/7.bmp'},
    {'name': 'stimuli/16.bmp', 'path': 'stimuli/16.bmp'},
    {'name': 'stimuli/17.bmp', 'path': 'stimuli/17.bmp'},
    {'name': 'stimuli/8.bmp', 'path': 'stimuli/8.bmp'},
    {'name': 'stimuli/18.bmp', 'path': 'stimuli/18.bmp'},
    {'name': 'stimuli/19.bmp', 'path': 'stimuli/19.bmp'},
    {'name': 'stimuli/4.bmp', 'path': 'stimuli/4.bmp'},
    {'name': 'stimuli/5.bmp', 'path': 'stimuli/5.bmp'},
    {'name': 'stimuli/11.bmp', 'path': 'stimuli/11.bmp'},
    {'name': 'stimuli/13.bmp', 'path': 'stimuli/13.bmp'},
    {'name': 'stimuli/2.bmp', 'path': 'stimuli/2.bmp'},
    {'name': 'stimuli/3.bmp', 'path': 'stimuli/3.bmp'},
    {'name': 'stimuli/14.bmp', 'path': 'stimuli/14.bmp'},
    {'name': 'stimuli/15.bmp', 'path': 'stimuli/15.bmp'},
    ...
    {'name': 'stimuli/1.bmp', 'path': 'stimuli/1.bmp'},
    {'name': 'stimuli/11.bmp', 'path': 'stimuli/11.bmp'},
    {'name': 'stimuli/12.bmp', 'path': 'stimuli/12.bmp'},
    {'name': 'stimuli/5.bmp', 'path': 'stimuli/5.bmp'},
    {'name': 'stimuli/20.bmp', 'path': 'stimuli/20.bmp'},
    {'name': 'stimuli/4.bmp', 'path': 'stimuli/4.bmp'},
    {'name': 'stimuli/2.bmp', 'path': 'stimuli/2.bmp'},
    ...
    {'name': 'stimuli/15.bmp', 'path': 'stimuli/15.bmp'},
    {'name': 'stimuli/7.bmp', 'path': 'stimuli/7.bmp'},
    {'name': 'stimuli/10.bmp', 'path': 'stimuli/10.bmp'},
    {'name': 'stimuli/16.bmp', 'path': 'stimuli/16.bmp'},
    {'name': 'stimuli/13.bmp', 'path': 'stimuli/13.bmp'},
    {'name': 'stimuli/19.bmp', 'path': 'stimuli/19.bmp'},
...
function instruction_congruentRoutineBegin(snapshot) {
  return async function () {
    ...
    instruction_congruentComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trials_loop_congruent_practiceLoopBegin(trials_loop_congruent_practiceLoopScheduler, snapshot) {
  return async function() {
    ...
    trials_loop_congruent_practice.forEach(function() {
...
function trials_loop_incongruent_practiceLoopBegin(trials_loop_incongruent_practiceLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    trials_loop_incongruent_practice.forEach(function() {
...
function trial_congruentRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_congruentComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instruction_incongruentRoutineBegin(snapshot) {
  return async function () {
    ...
    instruction_incongruentComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_incongruentRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_incongruentComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
